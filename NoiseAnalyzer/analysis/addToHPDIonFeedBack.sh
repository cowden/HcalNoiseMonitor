...
###
# This script adds a point to the HPD Ion feedback 
...
if [ "$#" -ne "3" ]; then
  ...
  echo "addToHPDIonFeedBack.sh runNumber inFile outFile"
  exit 1
fi
...
data=$(egrep "^[0-9]" $INFILE | gawk 'BEGIN { th20=0; th50=0; th100=0; th500=0;} { if ( $1 == 20 ) th20=$2; else if ( $1 == 50 ) th50=$2; else if ( $1 == 100 ) th100=$2; else if ( $1 == 500 ) th500=$2; } END { print th20,th50,th100,th500 }')
